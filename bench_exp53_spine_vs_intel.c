...
void exp53_spine_v128_u4_f6_cfirst(double*,const double*,size_t);
void exp53_spine_v128_u4_f6_cfirst_i(double*,const double*,size_t);
void exp53_spine_v128_u4_f6_cfirst_t(double*,const double*,size_t);
void exp53_spine_v128_u4_f6_sfirst_t(double*,const double*,size_t);
...
int main(void){setenv("MKL_NUM_THREADS","1",1);setenv("OMP_NUM_THREADS","1",1);mkl_set_num_threads_local(1);inputs();
 acc("u4_frozen",exp53_spine_v128_u4_frozen);acc("formula6",exp53_spine_v128_u4_formula6);acc("f6_cfirst",exp53_spine_v128_u4_f6_cfirst);acc("f6_cfirst_i",exp53_spine_v128_u4_f6_cfirst_i);acc("f6_cfirst_t",exp53_spine_v128_u4_f6_cfirst_t);acc("f6_sfirst_t",exp53_spine_v128_u4_f6_sfirst_t);
 double ha=bi(0,N);printf("INTEL_HA all=%.6f\n",ha);
 rep("u4_frozen",exp53_spine_v128_u4_frozen,ha);rep("formula6",exp53_spine_v128_u4_formula6,ha);rep("f6_cfirst",exp53_spine_v128_u4_f6_cfirst,ha);rep("f6_cfirst_i",exp53_spine_v128_u4_f6_cfirst_i,ha);rep("f6_cfirst_t",exp53_spine_v128_u4_f6_cfirst_t,ha);rep("f6_sfirst_t",exp53_spine_v128_u4_f6_sfirst_t,ha);return 0;}
