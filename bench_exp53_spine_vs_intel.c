...
int main(void){setenv("MKL_NUM_THREADS","1",1);setenv("OMP_NUM_THREADS","1",1);mkl_set_num_threads_local(1);inputs();acc("u4_frozen",exp53_spine_v128_u4_frozen);acc("formula6",exp53_spine_v128_u4_formula6);acc("f6_tabcomp",exp53_spine_v128_u4_formula6_tabcomp);acc("f6_direct",exp53_spine_v128_formula6_direct);double ha=bi(0,N);printf("INTEL_HA all=%.6f\n",ha);rep("u4_frozen",exp53_spine_v128_u4_frozen,ha);rep("formula6",exp53_spine_v128_u4_formula6,ha);rep("f6_tabcomp",exp53_spine_v128_u4_formula6_tabcomp,ha);rep("f6_direct",exp53_spine_v128_formula6_direct,ha);return 0;}
