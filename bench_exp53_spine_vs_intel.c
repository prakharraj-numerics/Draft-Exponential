...
void exp53_spine_v128_formula6_compacc(double*,const double*,size_t);
void exp53_spine_v128_formula6_compfastA(double*,const double*,size_t);
void exp53_spine_v128_formula6_compfastB(double*,const double*,size_t);
...
int main(void){setenv("MKL_NUM_THREADS","1",1);setenv("OMP_NUM_THREADS","1",1);mkl_set_num_threads_local(1);inputs();acc("formula6",exp53_spine_v128_u4_formula6);acc("f6_direct",exp53_spine_v128_formula6_direct);acc("f6_compacc",exp53_spine_v128_formula6_compacc);acc("compfastA",exp53_spine_v128_formula6_compfastA);acc("compfastB",exp53_spine_v128_formula6_compfastB);acc("compfastC",exp53_spine_v128_formula6_compfastC);double ha=bi(0,N);printf("INTEL_HA all=%.6f\n",ha);rep("formula6",exp53_spine_v128_u4_formula6,ha);rep("f6_direct",exp53_spine_v128_formula6_direct,ha);rep("f6_compacc",exp53_spine_v128_formula6_compacc,ha);rep("compfastA",exp53_spine_v128_formula6_compfastA,ha);rep("compfastB",exp53_spine_v128_formula6_compfastB,ha);rep("compfastC",exp53_spine_v128_formula6_compfastC,ha);return 0;}
