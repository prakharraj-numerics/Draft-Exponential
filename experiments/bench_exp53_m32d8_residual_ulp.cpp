...
#include "exp53_m32d8_residual_ulp_candidate.hpp"

using fn_t=void(*)(double*,const double*,size_t);
static volatile double g_sink=0.0;
extern "C" __attribute__((noinline)) void exp53_resulp_profile_start(){asm volatile("":::"memory");}
extern "C" __attribute__((noinline)) void exp53_resulp_profile_stop(){asm volatile("":::"memory");}
...
static void run_candidate(double*o,const double*x,size_t n){exp53_m32d8_residual_ulp::kernel(o,x,n);}
