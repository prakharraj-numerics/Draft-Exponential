...
#include "exp53_m32d8_eft_base_candidates.hpp"

using fn_t=void(*)(double*,const double*,size_t);
static volatile double g_sink=0.0;
extern "C" __attribute__((noinline)) void exp53_eft_profile_start(){asm volatile("":::"memory");}
extern "C" __attribute__((noinline)) void exp53_eft_profile_stop(){asm volatile("":::"memory");}
...
static void run_rcp14(double*o,const double*x,size_t n){exp53_m32d8_eft_base::rcp14(o,x,n);} 
static void run_lin(double*o,const double*x,size_t n){exp53_m32d8_eft_base::linrecip(o,x,n);} 
...
static fn_t choose(const std::string&s){if(s=="rcp14")return run_rcp14;if(s=="linrecip")return run_lin;if(s=="raw")return run_raw;if(s=="intel")return run_intel;if(s=="noop")return run_noop;return nullptr;}
