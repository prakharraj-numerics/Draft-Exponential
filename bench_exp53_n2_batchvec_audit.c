...
#include <string.h>
#include <time.h>
void exp53_n2_bv_u1(double*,const double*,size_t);void exp53_n2_bv_u2(double*,const double*,size_t);void exp53_n2_bv_u3(double*,const double*,size_t);void exp53_n2_bv_u4(double*,const double*,size_t);void exp53_n2_bv_u5(double*,const double*,size_t);void exp53_n2_bv_u6(double*,const double*,size_t);void exp53_n2_bv_mid_u4(double*,const double*,size_t);void exp53_n2_bv_late_u4(double*,const double*,size_t);void exp53_n2_bv_adaptive(double*,const double*,size_t);
...
struct{const char*n;fn f;}a[]={{"u1",exp53_n2_bv_u1},{"u2",exp53_n2_bv_u2},{"u3",exp53_n2_bv_u3},{"u4",exp53_n2_bv_u4},{"u5",exp53_n2_bv_u5},{"u6",exp53_n2_bv_u6},{"mid_u4",exp53_n2_bv_mid_u4},{"late_u4",exp53_n2_bv_late_u4},{"adaptive",exp53_n2_bv_adaptive}};int na=sizeof(a)/sizeof(a[0]);for(int i=0;i<na;i++)acc(a[i].n,a[i].f,y,x,N);
